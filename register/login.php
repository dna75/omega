...
<div class="row">
    <div class="col">
        <h6 class="mb-0 text-uppercase text-primary fw-bold">Ik heb al een account</h6>
        ...
        <form action=" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <a class="btn  btn-secondary" href="forgot_password.php">Wachtwoord vergeten?</a>
            </div>
            <div class="mb-3">
            </div>
            <p class="">Nog geen account? <a href="register.php">Maak een account aan</a>.</p>
        </form>
    </div>
</div>