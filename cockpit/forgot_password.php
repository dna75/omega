...
if (isset($_POST['email'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            $MESSAGE_BODY .= "" . PHP_EOL;
            $MESSAGE_BODY .= "<a href='$link/cockpit/forgot_password.php?uid=" . $row['id'] . "&code=" . $code . "'>$domein/cockpit/forgot_password.php?uid=" . $row['id'] . "&code=" . $code . "</a>" . PHP_EOL;
            $MESSAGE_BODY .= "" . PHP_EOL;
            $MESSAGE_BODY .= "" . PHP_EOL;
            $MESSAGE_BODY .= "Met vriendelijke groet,<br><br>Spinnerz.nl" . PHP_EOL;
            $MESSAGE_BODY .= "" . PHP_EOL;
    ...
    <div class="container">
        ...
        <? if (isset($send) && $send == false && $code_send == false) { ?>
            ...
            <form class="form-signin" action="/cockpit/forgot_password.php" method="post">
                ...
                <p style="color:#fff; font-size:13px;">Wachtwoord vergeten? Na het invoeren van je email adres ontvang je een link om je wachtwoord te resetten.</p>
