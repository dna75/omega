...
$fields     = array(
    ...
    'title'       => array('Hoofdtitel slider', 'text', 'multilingual ', '', 'De hoofdtitel van de slider'),
    'subtitle'       => array('Subtitel slider', 'text', 'multilingual ', '', 'De subtitel van de slider'),
    'picture'    => array('Afbeelding slider', 'image', 'remove_orig hide_overview min_width=960 min_height=540 max_width=960 max_height=540 aspect_ratio resize max_thumb_width=100 max_thumb_height=100 aspect_ratio thumb_crop_on'),
