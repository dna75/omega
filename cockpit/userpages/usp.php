...
$fields     = array(
    ...
    'title'       => array('Titel USP', 'text', '', '', 'Deze titel wordt getoond op de homepage onder `waarom kies jij voor Omega`'),
    'description' => array('Omschrijving USP', 'textarea', 'hide_overview', '', 'Deze omschrijving wordt getoond op de homepage onder `waarom kies jij voor Omega`'),
);
...
$page->showPage(true, false, false);              // Dit zal de normale order gebruiken (want orderfield = false) en deze reversen (want reverse  = true)
