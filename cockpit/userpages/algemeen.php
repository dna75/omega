...
$fields     = array(
    ...
    'companyname'             => array('Bedrijfsnaam', 'text', ''),
    'address'             => array('Adres', 'text', ''),
    'zipcode'             => array('Postcode', 'text', 'hide_overview'),
    'city'             => array('Woonplaats', 'text', 'hide_overview'),
    'phone'             => array('Telefoonnummer vast', 'text', 'hide_overview'),
    'mobile'             => array('Telefoonnummer mobiel', 'text', 'hide_overview'),
    'email'             => array('E-mail', 'text', 'hide_overview'),
    'startrental'          => array('Starttijd huurperiode', 'time', 'hide_overview', '', 'Starttijd die wordt weergegeveen in het reserveringsformulier'),
    'endrental'          => array('Eindtijd huurperiode', 'time', 'hide_overview', '', 'Eindtijd die wordt weergegeveen in het reserveringsformulier'),
    // 'picture2'         => array('Afbeelding facebook'        , 'image'        , 'remove_orig hide_overview min_width=851 min_height=315 max_width=851 max_height=315 aspect_ratio max_thumb_width=100 max_thumb_height=100'),
    // 'kaarten'        => array('Voorverkoop intern'        , 'boolean'        , 'hide_overview'),
    // 'date_to'         => array('Datum evenement'            , 'date'        , 'required'),
    // 'kind'             => array('Soort Artikel'            , 'select'        , '', 'nieuws|blog', 'Selecteer de pagina waar dit onderdeel getoond wordt'),
    // 'icon'             => array('Icoon'                    , 'icon'        , 'hide_overview', '', 'Het gekozen icoon wordt in de banner getoond'),
    // 'description'    => array('Omschrijving'                , 'textarea'    , 'hide_overview')
);
