...
*/
//$baseUrl = '/fotomanager/images/userfiles/';
...
ATTENTION: The trailing slash is required.
*/
$baseDir = '/var/www/vhosts/spinnerz.nl/test.spinnerz.nl/fotomanager/images/userfiles/';
//$baseDir = '/var/www/vhosts/xs57.nl/httpdocs/stadscafe/uploadsck/';
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => "16M",
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,avi,iso,mp3,pdf,doc',
		'deniedExtensions' => '');
