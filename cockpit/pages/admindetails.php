...
$pageName     = 'admindetails';

$fields     = array(
    //    'name'             => array('Evenement naam'            , 'text'        , 'overview_width=130 or hide_overview',         'class class',             'Tooltip'),
    'homelink'        => array('Shortcut link naar pagina', 'text', ''),
    'homelinkdescription' => array('Shortcut omschrijving', 'text', ''),
    'defaultPage'     => array('Default page', 'text', ''),
    'analytics'       => array('Analytics ID', 'text', '')
);
